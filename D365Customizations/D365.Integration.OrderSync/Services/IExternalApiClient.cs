...
{
    /// <summary>
    /// Sends <see cref="OrderDetailsPayload"/> to an external system and returns a normalized <see cref="ApiResponse"/>.
    /// </summary>
    public interface IExternalApiClient
    {
        /// <summary>
        /// POSTs JSON representing the order; does not throw on HTTP error status (see <see cref="ApiResponse"/>).
        /// </summary>
